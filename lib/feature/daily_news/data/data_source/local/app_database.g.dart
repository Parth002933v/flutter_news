...
class _$AppDatabase extends AppDatabase {
  ...
  ArticleModelDAO? _articleModelDAOInstance;
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ArticleModel` (`id` INTEGER, `author` TEXT, `title` TEXT, `description` TEXT, `url` TEXT, `urlToImage` TEXT, `publishedAt` TEXT, `content` TEXT, PRIMARY KEY (`id`))');
  ...
  ArticleModelDAO get articleModelDAO {
    return _articleModelDAOInstance ??=
        _$ArticleModelDAO(database, changeListener);
  }
}

class _$ArticleModelDAO extends ArticleModelDAO {
  _$ArticleModelDAO(
    this.database,
    this.changeListener,
